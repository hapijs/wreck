...
declare class Client {
     ...
     * @returns A promise resolving into an HTTP response object with a 'req' property holding a reference to the HTTP
     *   request object.
     */
    request(
        method: string,
...
declare namespace Client {
    ...
    namespace request {
        interface Options {
            ...
            /**
             * IP address family to use when resolving host or hostname. Valid values are 4 or 6. When unspecified, both
             * IP v4 and v6 will be used.
             */
             ...
             * @param redirectOptions - Options that will be applied to the redirect request. Changes to this object are
             *   applied to the redirection request.
            ...
            readonly beforeRedirect?: (
                ...
                redirectOptions: Client.request.Options,
                next: () => void,
            ) => void;
            ...
            /**
             * The request body as a string, Buffer, readable stream, or an object that can be serialized using
             * `JSON.stringify()`.
             */
