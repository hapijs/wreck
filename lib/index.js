...
internals.Client.prototype.get = function (uri, options, callback) {
    ...
    return this.shortcutWrap('GET', uri, options, callback);
};


internals.Client.prototype.post = function (uri, options, callback) {

    return this.shortcutWrap('POST', uri, options, callback);
};


internals.Client.prototype.put = function (uri, options, callback) {

    return this.shortcutWrap('PUT', uri, options, callback);
};


internals.Client.prototype.delete = function (uri, options, callback) {

    return this.shortcutWrap('DELETE', uri, options, callback);
};
...
internals.Client.prototype.shortcutWrap = function (method, uri /* [options], callback */) {
    ...
    return this.shortcut(method, uri, options, callback);
};


internals.Client.prototype.shortcut = function (method, uri, options, callback) {
