...
exports.agents = {
    http: new Agent.Http({ maxSockets: Infinity }),
    https: new Agent.Https({ maxSockets: Infinity }),
    httpsAllowUnauthorized: new Agent.Https({ maxSockets: Infinity, rejectUnauthorized: false })
};
