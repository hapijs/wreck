...
module.exports.request = function (method, url, options, callback, _trace) {
    ...
    if (options.rejectUnauthorized !== undefined && uri.protocol === 'https:') {
        uri.agent = options.rejectUnauthorized ? module.exports.agents.https : module.exports.agents.httpsAllowUnauthorized;
    }
    else if (options.agent || options.agent === false) {
        uri.agent = options.agent;
    }
    else {
        uri.agent = uri.protocol === 'https:' ? module.exports.agents.https : module.exports.agents.http;
    }
    ...
    var finish = function (err, res) {
        ...
        module.exports.emit('response', err, req, res, _trace);
    ...
    var onResponse = function (res) {
        ...
        return module.exports.request(redirectMethod, location, redirectOptions, finish, _trace);
    };
...
module.exports.read = function (res, options, callback) {
...
module.exports.toReadableStream = function (payload, encoding) {
...
module.exports.parseCacheControl = function (field) {
...
module.exports.put = function (uri, options, callback) {

    return internals.shortcutWrap('PUT', uri, options, callback);
};


module.exports.delete = function (uri, options, callback) {
...
internals.shortcut = function (method, uri, options, callback) {
    ...
    return module.exports.request(method, uri, options, function (err, res) {

        if (err) {
            return callback(err);
        }

        module.exports.read(res, options, function (err, payload) {
