...
exports.parse = function (res /*, [options], callback */) {
    ...
    var writer = new internals.Tap({ maxBytes: options.maxBytes });
...
internals.Tap = function (options) {
...
internals.Tap.prototype._transform = function (chunk, encoding, callback) {
