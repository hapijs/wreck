...
describe('request()', () => {
    ...
    it('calls beforeRedirect option callback before redirections', (done) => {
        ...
        const beforeRedirectCallback = (redirectMethod, statusCode, location, redirectOptions) => {
    ...
    it('calls redirected option callback on redirections', (done) => {
        ...
        let redirects = 0;
        const redirectedCallback = (statusCode, location, req) => {
    ...
    it('requests head method', (done) => {
        ...
        server.listen(0, () => {
            ...
            new Buffer(internals.payload, 'ascii');
